...
const score = document.querySelectorAll('.points'); // Use querySelector() to get the score element
const timerDisplay = document.querySelectorAll('.time'); // use querySelector() to get the timer element.
